...
export const playerIcon = `<img src="./src/assets/logo-92c8d2bb.svg" alt="super maize boy" width="40%" height="90%"/>`;
export const cornIcon = `<img src="./src/assets/corn-e070da5d.svg" alt="corn icon" width="40%" height="90%"/>`;
